...
<div id="page-content-wrapper">
    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container">
            <h1>Tambahkan Jenis Usaha</h1>
            <a href="/db_admin-jenis_usaha" class="btn btn-info btn-edit text-light">Back</a>
            <form action="{{ route('admin-jenisUsahas.store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="content">
                    <div class="kanan">
                        <div class="jenisUsaha">
                            ...
                            @error('jenisUsaha')
                                is-invalid
                            @enderror" placeholder="Masukkan nama jenis usaha" value="{{ old('jenisUsaha') }}">
                            @error('jenisUsaha')
